  ...
  if (checking) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-black">
        <div className="text-zinc-700 text-sm">Checking session...</div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-sm space-y-8">
        <div className="text-center space-y-3">
          <div className="mx-auto w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-zinc-300 text-3xl font-bold">
            P
          </div>
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-zinc-100">Priya Portal</h1>
            <p className="text-zinc-600 text-sm mt-1">Your personal space with Priya</p>
          </div>
        </div>

        <div className="space-y-2">
          {features.map((f) => (
            <div key={f.label} className="flex items-center gap-3 text-sm text-zinc-600">
        ...
        <a href="/api/auth/discord">
          <Button className="w-full bg-zinc-200 hover:bg-white text-black font-semibold h-11 gap-2 transition-colors">
